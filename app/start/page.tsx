  ...
  return (
    <PageShell active="start">
      ...
      <div className="w-full max-w-3xl">
        <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-gold-700 sm:text-sm">
          <Leaf size={14} strokeWidth={1.8} />
          Faith Quiz
        </p>
        <h1 className="mt-1.5 font-serif text-[1.75rem] font-semibold leading-[1.05] text-ink-900 sm:mt-5 sm:text-6xl">
